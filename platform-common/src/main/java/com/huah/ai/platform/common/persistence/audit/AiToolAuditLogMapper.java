...
public interface AiToolAuditLogMapper extends BaseMapper<AiToolAuditLogEntity> {
    ...
    List<AiToolAuditLogEntity> selectRecent(
    ...
    List<AiToolAuditLogEntity> selectRecentByAgentTypeAfter(
            @Param("agentType") String agentType,
    ...
    List<AiToolAuditLogEntity> selectArchiveCandidates(
            @Param("agentType") String agentType,
            @Param("before") LocalDateTime before,
            @Param("limit") int limit);

    List<AiToolAuditLogEntity> selectArchiveCandidatesBatch(
            @Param("agentType") String agentType,
            @Param("before") LocalDateTime before,
            @Param("limit") int limit,
